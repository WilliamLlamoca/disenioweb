...
mysql_select_db('disenoweb')or die ('Error al seleccionar la Base de Datos: '.mysql_error());
...
**le ha enviado*/
$result = mysql_query("SELECT * FROM sesiones WHERE usuario = '$usuario'");
